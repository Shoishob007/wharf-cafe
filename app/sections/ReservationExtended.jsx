      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <h3 className="mb-2 font-semibold text-foreground">Group Size</h3>
          ...
          >
            ...
            <h3 className="mb-2 font-semibold text-foreground">Holding Time</h3>
            <p className="text-sm text-muted-foreground">
              Tables are held for 15 minutes past the booking time. Please let
              us know if you are running late.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mt-12 flex items-start gap-4 border-t border-border pt-6"
        >
          <Info className="mt-1 h-5 w-5 shrink-0 text-primary" />
          <p className="text-sm text-muted-foreground">
            A 15% surcharge applies on public holidays. We are a cashless café
            for card payments, and takeaway orders can be paid on pickup. For
            any changes to your booking, please call us directly.
          </p>
        </motion.div>
      </div>
    </section>
