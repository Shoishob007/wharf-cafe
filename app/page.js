...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* Parallax callout */}
      <ParallaxSection image="/cafe-menu/gallery-07.jpg" height="50vh">
        <h2 className="mb-4 text-3xl font-bold sm:text-4xl">
          Right on the Water
        </h2>
        <p className="mb-6 max-w-2xl text-lg text-white/90">
          Eat, drink, and relax with the tide at Maraetai Wharf.
        </p>
        <Button href="/reservation/">Book a Table</Button>
      </ParallaxSection>
      ...
      <section id="home-reservation" className="bg-muted py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <ShapedImage
              src="/cafe-menu/breakfast-05.jpg"
              alt="Breakfast at the wharf"
              shape="leaf"
              className="aspect-[4/3] w-full"
            />
          </div>
